...
// Fail-safe MongoDB Connection Setup
mongoose.connect(MONGO_URI)
  ...
  .catch(err => {
    ...
    console.log('--- WARNING: Application is running without a connected MongoDB database. Ensure MongoDB is running locally. ---')
  })
...
async function seedDatabase() {
  try {
    ...
    // Wipe and re-seed to ensure latest schema is loaded
    await Restaurant.deleteMany({})
    console.log('Cleared existing restaurants for fresh seed...')

    console.log('Seeding initial premium restaurant and menu data...')
    ...
    const mockRestaurants = [
      {
        ...
        menu: [
          ...
          },
          {
            ...
            description: 'Creamy cheese sauce, wild forest mushrooms, and white truffle oil drizzle.',
            price: 349,
            category: 'Main Course',
            isVeg: true,
            isPopular: false,
          ...
          },
          {
            ...
            description: 'Golden oven-baked dough brushed with herb butter and served with marinara sauce.',
            price: 149,
            category: 'Starters',
            isVeg: true,
            isPopular: true,
          ...
          },
          {
            ...
            description: 'Rich espresso-soaked ladyfingers layered with sweet mascarpone cream and cocoa powder.',
            price: 249,
            category: 'Desserts',
            isVeg: true,
            isPopular: true,
        ...
        menu: [
          {
            ...
            description: 'Flame-grilled prime patty, melted sharp cheddar, smoked wood smoke sauce, lettuce, and pickles.',
            price: 249,
            category: 'Main Course',
            isVeg: false,
            isPopular: true,
          ...
          },
          {
            ...
            description: 'Butter-toasted soft brioche bun, Swiss Emmental cheese, caramelized onions, and garlic-truffle aioli.',
            price: 289,
            category: 'Main Course',
            isVeg: false,
            isPopular: false,
          ...
          },
          {
            ...
            description: 'Double-fried crispy thin potatoes dusted in peri-peri spices and layered in warm melted cheese.',
            price: 129,
            category: 'Starters',
            isVeg: true,
            isPopular: true,
          ...
          },
          {
            ...
            description: 'Churned Madagascan vanilla ice cream blended with cold milk, topped with rich whipped cream.',
            price: 179,
            category: 'Beverages',
            isVeg: true,
            isPopular: false,
        ...
        menu: [
          {
            ...
            description: 'Fresh sliced Atlantic salmon, creamy Hass avocado, rolled in seasoned sushi rice, topped with golden tobiko.',
            price: 499,
            category: 'Main Course',
            isVeg: false,
            isPopular: true,
          ...
          },
          {
            ...
            description: 'Flash-fried crispy jumbo shrimp tempura rolled in rice with spicy wasabi mayo and sweet unagi soy reduction.',
            price: 449,
            category: 'Main Course',
            isVeg: false,
            isPopular: true,
          ...
          },
          {
            ...
            description: 'Cucumber, pickled carrot, pickled radish rolled and topped with paper-thin slices of ripe avocado.',
            price: 399,
            category: 'Main Course',
            isVeg: true,
            isPopular: false,
          ...
          },
          {
            ...
            description: 'Chewy sweet Japanese rice cakes filled with premium slow-churned green tea matcha ice cream.',
            price: 199,
            category: 'Desserts',
            isVeg: true,
            isPopular: false,
        ...
        menu: [
          {
            ...
            description: 'Fresh golden Belgian waffle, dark chocolate glaze, white chocolate drizzle, and organic cocoa nibs.',
            price: 199,
            category: 'Desserts',
            isVeg: true,
            isPopular: true,
          ...
          },
          {
            ...
            description: 'Soft white chocolate sponge cake with a warm flowing blueberry reduction center, baked to order.',
            price: 189,
            category: 'Desserts',
            isVeg: true,
            isPopular: false,
          ...
          },
          {
            ...
            description: 'Fluffy scarlet vanilla sponge cake crowned with an elegant whipped sweet cream cheese icing peak.',
            price: 99,
            category: 'Desserts',
            isVeg: true,
            isPopular: true,
          ...
          },
          {
            ...
            description: 'Delicate French almond shells sandwiched with a rich caramel ganache and fine sea salt flakes.',
            price: 79,
            category: 'Desserts',
            isVeg: true,
            isPopular: false,
    ...
    console.log('Seeding complete! 4 beautiful restaurants with full menus populated.')
  } catch (error) {
